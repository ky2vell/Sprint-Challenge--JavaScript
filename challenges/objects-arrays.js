...
const universities = graduates.map(newArr => newArr.university);
...
const contactInfo = graduates.map(newArr => newArr.first_name + '\xa0' + newArr.email);
console.log(contactInfo);

/* Request 3: Find out how many universities have the string "Uni" included in their name. Create a new array called unisWithUni that contains them all. This will be an array of objects. Log the result. */
const unisWithUni = graduates.filter(newObj => newObj.university.includes('Uni'));
...
const lowCaseAnimalNames = zooAnimals.map(newArr => newArr.animal_name.toLowerCase());
...
*/
const lowPopulationAnimals = zooAnimals.filter(newArr => newArr.population < 5);
